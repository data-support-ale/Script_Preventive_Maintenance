...
echo "##############################################################################"
echo "#                                                                            #"
echo "###################### Preventive Maintenance 1.0 ############################"
echo "#                                                                            #"
echo "##############################################################################"
echo "      "
...
configuration () {
     ...
     case $yn in
               [Nn]* ) ap="0" ;;
               [Yy]* ) ap="1"
                    echo "What are the WLAN Stellar AP credentials for SSH?"
                    login_AP="support"
                    read -p "Password : " pass_AP
                    read -p "Technical Support code : " tech_pass
                    echo
                    echo "If you want to monitor specific patterns generated by WLAN Stellar APs, please enter the list here.
                    ==> "Example: policy exception"
                    ==> "Example: crash"
                    ==> "Example: reboot""
                    echo
...
if [ "$ap" == "1" ]
then
echo "WLAN Stellar APs Login: support"
echo "WLAN Stellar APs Password: $pass_AP"
echo "WLAN Stellar APs technical support code: $tech_pass"
echo "Your WLAN Stellar APs patterns: "
