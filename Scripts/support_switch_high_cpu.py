...
import os
import datetime
from support_tools_OmniSwitch import get_credentials, get_tech_support_sftp, ssh_connectivity_check, send_file
...
filename = "{0}_{1}-{2}_{3}_high_cpu_logs".format(date, date_hm.hour, date_hm.minute, ipadd)
