...
if save_resp == "0":
    ...
    if lldp_port_description == 0:
       ...
       send_file(filename_path, subject, action, result, category) 
        ...
        notif = "A LinkAgg Port Leave occurs on OmniSwitch " + host + " port " + port + " LinkAgg " + agg + " - Port Description: " + lldp_port_description + ". Device information: " + device_ip + "/" + lldp_mac_address + " is connected to this port, do you want to collect logs? The port-monitoring capture of port " + port + " is available on Server " + ip_server + " directory /tftpboot/"
        answer = send_message_request(notif, jid)
    print(answer)
    sleep(2)
