...
last = ""
with open("/var/log/devices/lastlog_spb.json", "r", encoding="utf8", errors='ignore') as log_file:
    for line in log_file:
        last = line

with open("/var/log/devices/lastlog_spb.json","w", encoding="utf8", errors='ignore') as log_file:
    log_file.write(last)
